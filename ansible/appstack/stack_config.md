...
# cd webapps
# rm -rf *
# wget https://github.com/raghuk134/ansible/raw/master/appstack/student.war
# cd ../lib
# wget https://github.com/raghuk134/ansible/raw/master/appstack/mysql-connector-java-5.1.40.jar
# cd ../bin
# sh startup.sh
```
